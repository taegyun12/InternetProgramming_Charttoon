...
<section>
<div class="enrollTitle">웹툰 등록하기</div>
<div class="toonInform"></div>
<div class="enrollTable">
<form action="Enroll_do.jsp" method="post" enctype="multipart/form-data"> <!-- 새로운 웹툰을 등록하기 위한 입력창 -->
	제목:<input type="text" name="title" style="width:300px"><br>
	작가명:<input type="text" name="author" style="width:300px"><br>
	웹툰 썸네일:<input type="file" accept="image/jpg,image/gif" name="thumbNail"><br>
	...
	<div>
	줄거리<br>
	<input type="text" name="shorts" style="height:85px; width:650px;font-size:10px;"><br>
	</div>
	<div>
	작가의 소개글<br>
	<input type="text" name="introduce" style="height:85px; width:650px;font-size:10px;"><br>
	</div>
	<div>
