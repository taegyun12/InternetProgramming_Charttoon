...
String title=request.getParameter("title"); //전 페이지에서 title을 매개변수로 받음
...
try {
    ...
    String query = "select idx,title,genre,author,savedFileName from webtoonList where title like '%" + title + "%'"; //webtoon 테이블에서 제목에 title이 포함된 모든 웹툰의 정보를 가져옴
...
<table border="1" class="detailTable"> <!-- 표형식으로 출력 -->
